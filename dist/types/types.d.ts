...
declare class TypeWrapper<K extends Provider> {
    wrapped(options: IAuthOptions<K>): {
        ...
        hasAuthLink: typeof import("./utils/helpers").hasAuthLink;
        ensureDisplayName: typeof import("./utils/helpers").ensureDisplayName;
        mapUser: typeof import("./utils/helpers").mapUser;
...
export declare type AuthApi<K extends Provider> = ReturnType<TypeWrapper<K>['wrapped']>;
