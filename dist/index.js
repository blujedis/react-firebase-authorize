/*!
 * react-firebase-authorize v0.0.1
...
function hasAuthLink() {
    return firebase$1.auth().isSignInWithEmailLink(window.location.href);
}
...
function mapUser(user, extend) {
    ...
    var infoUser = infoKeys.reduce(function (a, k) {
        if (typeof usr[k] !== 'undefined')
            a[k] = usr[k];
        return a;
    }, {});
    infoUser = ensureDisplayName(infoUser);
    return __assign(__assign({}, infoUser), extend);
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    currentUser = firebase$1.auth().currentUser;
                    if (!currentUser)
                        throw new Error("Cannot update profile with user of undefined.");
                    return [4 /*yield*/, currentUser.updateProfile(profile)];
                case 1:
                    _a.sent();
...
var AUTH_DEFAULTS = {
    ...
    onAuthCredential: function (userCredential) {
        var _a, _b;
        var user = userCredential.user;
        var extend = {
            idToken: (_a = userCredential.credential) === null || _a === void 0 ? void 0 : _a.idToken,
            accessToken: (_b = userCredential.credential) === null || _b === void 0 ? void 0 : _b.accessToken
        };
        return mapUser(user, extend);
    },
    logger: function (_a) {
        var timestamp = _a.timestamp, level = _a.level, message = _a.message;
        return console.log("[" + timestamp + "]:" + level, message);
    },
    globalActionCodes: __assign({}, ACTION_CODES)
};
var PROVIDERS = {
    google: function () { return new firebase$1.auth.GoogleAuthProvider(); },
    facebook: function () { return new firebase$1.auth.FacebookAuthProvider(); },
    github: function () { return new firebase$1.auth.GithubAuthProvider(); },
    twitter: function () { return new firebase$1.auth.TwitterAuthProvider(); },
    microsoft: function () { return new firebase$1.auth.OAuthProvider('microsoft.com'); },
    yahoo: function () { return new firebase$1.auth.OAuthProvider('yahoo.com'); },
    apple: function () { return new firebase$1.auth.OAuthProvider('apple.com'); },
    phone: function (auth) { return new firebase$1.auth.PhoneAuthProvider(auth); }
};
...
function initLink(options) {
    var _a = options, emailVerificationUrl = _a.emailVerificationUrl, emailStorageLinkKey = _a.emailStorageLinkKey, log = _a.log, model = _a.model, globalActionCodes = _a.globalActionCodes;
...
function initPassword(options) {
    var _a = options, userStorageKey = _a.userStorageKey, log = _a.log, model = _a.model, emailVerificationUrl = _a.emailVerificationUrl, globalActionCodes = _a.globalActionCodes;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, firebase$1.auth().fetchSignInMethodsForEmail(email)];
                    case 1:
                        methods = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, firebase$1.auth().sendPasswordResetEmail(email)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, true];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, firebase$1.auth().verifyPasswordResetCode(code)];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, firebase$1.auth().confirmPasswordReset(code, newPassword)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, true];
                    case 2:
...
function initProvider(options) {
    var _a = options, userStorageKey = _a.userStorageKey, log = _a.log, model = _a.model, enabledProviders = _a.enabledProviders;
    var providers = {};
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        provider = typeof providerId === 'string' ? getProvider(providerId) : providerId;
                        return [4 /*yield*/, firebase$1.auth().currentUser];
                    case 1:
                        currentUser = _a.sent();
                        if (!currentUser)
...
function initPhone(options) {
    var _a = options, userStorageKey = _a.userStorageKey, log = _a.log, model = _a.model;
...
function initModel(options) {
    var _a = options, collectionName = _a.collectionName, updateProps = _a.updateProps, onAuthCredential = _a.onAuthCredential, databasePersist = _a.databasePersist;
    function getRef() {
        return firebase$1.firestore().collection(collectionName);
    }
    /**
...
function createUseIdentity(auth) {
    var useIdentity = function (props) {
        props = __assign(__assign({}, IDENTITY_DEFAULTS), props);
        var defaultUser = props.defaultUser;
        var signInByLink = auth.link.signIn;
        var signInByProvider = auth.provider.signIn;
        var signInByPassword = auth.password.signIn;
        var signInByPhone = auth.phone.signIn;
        var user = ensureUser();
        function ensureUser() {
            var user = auth.getStorageUser(defaultUser);
...
function useRecaptcha() {
    ...
    function createVerifier(options) {
        var captcha = new firebase$1
            .auth
            .RecaptchaVerifier(ref.current, __assign({ size: 'invisible' }, options));
        if (typeof window !== 'undefined') {
            window.recaptchaVerifier = captcha;
            captcha.render().then(function (id) { return (window.recaptchaWidgetId = id); });
        }
        return captcha;
    }
...
function initApi(options) {
    ...
    var _a = options, userStorageKey = _a.userStorageKey, emailStorageLinkKey = _a.emailStorageLinkKey, isAuthenticatedKey = _a.isAuthenticatedKey, onAuthCredential = _a.onAuthCredential, enableWatchState = _a.enableWatchState;
    ...
    var hasStorageUser = function () { return storage.has(userStorageKey); };
    var hasStorageEmailLink = function () { return storage.has(emailStorageLinkKey); };
    var getStorageUser = function (def) {
        if (def === void 0) { def = null; }
        return storage.get(userStorageKey, def);
    };
    var getStorageEmailLink = function (def) {
        if (def === void 0) { def = null; }
        return storage.get(emailStorageLinkKey, def);
    };
    var setStorageUser = function (value) { return storage.set(userStorageKey, value); };
    ...
    var password = initPassword(initOptions);
    var phone = initPhone(initOptions);
    var provider = initProvider(initOptions);
    ...
    function signOut(redirect) {
        return firebase$1.auth().signOut().then(function () {
            storage.remove(userStorageKey);
            if (redirect) {
    ...
    function watchState(handler) {
        ...
        var unsubscribe = firebase$1.auth().onAuthStateChanged(function (user) {
            if (handler)
                return handler(user);
            if (!user) {
                removeStorageUser();
            ...
            // }
                ...
                if (!hasStorageUser()) {
                    var usr = onAuthCredential({ user: user });
                    if (usr)
                        setStorageUser(usr);
                }
    ...
    return {
        ...
        getStorageEmailLink: getStorageEmailLink,
...
function createAuth(options) {
    var auth = initApi(options);
    var useIdentity = createUseIdentity(auth);
    return {
        auth: auth,
